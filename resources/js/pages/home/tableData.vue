<template>
        ...
        <tbody>
            <tr v-for="(row, index) in data">
                ...
                <td class="flex items-center gap-x-2">
                    <div class="tooltip" data-tip="Edit Mahasiswa">
                        <button class="btn btn-circle btn-sm" @click="store.commit('setStudentAction', row)">
    ...
    <h1 class="text-xl text-center" v-if="data == undefined || data.length == 0">Belum ada data mahasiswa!</h1>
</template>
